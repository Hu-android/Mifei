...
public class txt_et_item extends FrameLayout{
    ...
    private void initData(Context context,AttributeSet attrs){
        TypedArray ta1 = context.obtainStyledAttributes(attrs, R.styleable.txt_et_item_te);
        String txt_item = ta1.getString(R.styleable.txt_et_item_te_te_item_txt);
        String et_item = ta1.getString(R.styleable.txt_et_item_te_te_item_et);
