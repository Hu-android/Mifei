...
import com.example.administrator.mifei.BuildConfig;
import com.example.administrator.mifei.R;
import com.example.administrator.mifei.utils.ClickListener;
import com.example.administrator.mifei.utils.FileUtil;
import com.example.administrator.mifei.view.ClipImageActivity;
...
public class Setting extends BaseBackActivity{
    ...
    public void initView(Bundle savedInstanceState) {
        headImage1 = (ImageView) findViewById(R.id.tii_item_img_head);
    ...
    private void gotoCamera() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            Uri contentUri = FileProvider.getUriForFile(Setting.this, BuildConfig.APPLICATION_ID + ".fileProvider", tempFile);
