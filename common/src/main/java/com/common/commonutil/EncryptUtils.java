...
import static com.common.commonutil.ConvertUtils.byte2hex;
import static com.common.commonutil.ConvertUtils.bytes2HexString;
import static com.common.commonutil.ConvertUtils.hex2byte;
import static com.common.commonutil.ConvertUtils.hexString2Bytes;
...
public class EncryptUtils {
    ...
    public static String encryptMD5ToString(String data, String salt) {
        return byte2hex(encryptMD5((data + salt).getBytes()));
    }
    ...
    public static String encryptMD5ToString(byte[] data, byte[] salt) {
        ...
        return byte2hex(encryptMD5(dataSalt));
    }
     ...
     * @return 16进制密文
     */
    public static String encryptAES2HexString(String data, String key) {
        return bytes2HexString(encryptAES(data.getBytes(), key.getBytes()));
    }
     ...
     * @return 16进制密文
     */
    public static String encryptAES2String(String data, String key) {
     ...
     * @return 密文
     */
    public static byte[] encryptAES2(byte[] data, byte[] key) {
        return DESTemplet(data, key, AES_Algorithm, "AES-128-CBC", true);
    }
     ...
     * @return 明文
     */
    public static String decryptAESToString(String data, String key) throws Exception {
        byte[] bytes = DESTemplet(hex2byte(data), key.getBytes("UTF-8"), AES_Algorithm, AES_Transformation, false);
